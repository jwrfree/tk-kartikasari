...
export const costStructure: CostItem[] = [
  ...
  },
  {
    ...
    amount: 600000,
    category: 'Uang Pangkal',
    description: 'Meliputi field trip, perayaan hari besar, dan materi proyek tematik sepanjang tahun.',
    includedInCalculator: true,
    type: 'sekali bayar',
  },
  {
...
export const installmentProgram: InstallmentProgram = {
  ...
  description:
    'Kami menyediakan beberapa opsi pembayaran uang pangkal untuk meringankan beban finansial Anda. Silakan pilih opsi yang paling sesuai.',
  options: [
  ...
  points: [
    {
      ...
      content:
        'Jika pembatalan dilakukan 2 minggu sebelum hari pertama sekolah, 75% dari uang pangkal akan dikembalikan. SPP dan biaya seragam dikembalikan penuh.',
    },
    {
    ...
    },
    {
      ...
      content:
        'Untuk kasus pindah domisili yang dibuktikan dengan surat resmi, kebijakan pengembalian dana dapat didiskusikan secara individual dengan pihak sekolah.',
    },
    {
      title: 'Biaya yang Tidak Dapat Dikembalikan',
      content:
        'Biaya formulir pendaftaran dan biaya kegiatan yang sudah berjalan tidak dapat dikembalikan dalam kondisi apa pun.',
    },
  ],
};
...
export const strukturBiaya = {
  ...
  komponen: costStructure
    .filter((i) => i.includedInCalculator)
    .map((item) => ({
      nama: item.name,
      jumlah: item.amount,
